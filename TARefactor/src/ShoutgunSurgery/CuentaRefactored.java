 ...
 */
package ShoutgunSurgery;

/**
 *
 * @author Elena
 */
public class CuentaRefactored {

    private String type;
    private String accountNumber;
    private int amount;

    public CuentaRefactored(String type, String accountNumber, int amount) {
        this.amount = amount;
        this.type = type;
    ...
    public void transfer(CuentaRefactored from, CuentaRefactored to, int cerditAmount) throws Exception {
        if (isAccountUnderflow()) {
            throw new Exception("Mininum balance shuold be over 500");
        }
